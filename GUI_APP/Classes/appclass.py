...
class App():
    ...
    def memory_options(self, file=None):
        if file:
            with open("Users/terrancemccoy/IT_533_trrncmcco/IT533_trrncmcco/GUI_APP/file1.json") as f:
                data = json.load(f)
    ...
    def getFile(self, *args):
        ...
        if openfile:
            with open(openfile) as my_file:
                ...
                self.comboBoxVal.current(self.memory_options.index(config_vars["memory"]))
